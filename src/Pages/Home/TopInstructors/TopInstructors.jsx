    ...
    return (
        <div className="mt-20 p-4 lg:p-0">
            <div className="text-center">
                ...
                <h3 className="text-5xl mt-2 font-semibold ">Top Instructors</h3>
            </div>
                        ...
                        <div className="bg-[#F0F7FF]">
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex justify-between mt-8">
                                    <p className="flex cursor-pointer items-center gap-2 font-bold text-[#FF7350]">See More <FaArrowRight/></p>
